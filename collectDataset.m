...
% application run:
%
%    collectDataset('nameofdataset.mat')
%
...
% To stop execution of the program, simply close the figure window.
    ...
    function processEncoders(sub, msg)
        ...
        dataset(encoderCount + 1,:) = [toc(datasetStartTime) msg.Data' lastAccel'];
    ...
    global dataset datasetStartTime encoderCount lastAccel;
